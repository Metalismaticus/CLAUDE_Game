---
name: setup
description: Развернуть в папке проекта процесс studio — узнать замысел окнами, проверить компьютер и поставить недостающие программы после «да», разобрать образцы владельца в docs/refs/, создать CLAUDE.md и docs/, поставить Этап 1 вертикальным срезом, для игры на движке — создать каркас и показать живое окно игры. Работает в пустой папке и в проекте с кодом; /setup обновить переносит в развёрнутый проект новый шаблон процесса. Звать по команде /setup.
