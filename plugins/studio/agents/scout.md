...
3. Для каждого пункта ответить:
   ...
   - **зависимость** — нужен ли ему результат другого пункта партии (`[вид]`
     зависит от пункта «Стенд вида» партии, если он есть);
   - **особый род** — замер производительности или времени (одновременные
     ...
     работа с данными пользователя, пункт `[вид]` (идёт кругами и ждёт выбора
     владельца между ними; снимки стенда — по одному);
